...
document.onkeydown = function (e) {
	...
	switch (e.which || e.keyCode) {
		...
		case 71 : // Goal, g
			increment_stat('Goals'); increment_stat('Shots'); increment_stat('Plus'); if (onice) {pause_resume();} break;
		case 65 : // Assist, a
			increment_stat('Assists'); increment_stat('Plus'); if (onice) {pause_resume();} break;
		case 39 : // Plus, <right>
			increment_stat('Plus'); if (onice) {pause_resume();} break;
		case 37 : // Minus, <left>
			increment_stat('Minus'); if (onice) {pause_resume();} break;
		case 88 : // Shot, x
